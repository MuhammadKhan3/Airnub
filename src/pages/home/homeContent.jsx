...
const HomeContent = () => {
  ...
  return (
    <section className=' xl:bg-gradient-to-tr 2xl:bg-gradient-to-tr 3xl:bg-gradient-to-tr  bg-gradient-to-tr  from-pink-50 via-pink-50   to-blue-50 mix-blend-multiply             text-black  h-screen min-h-full mb:min-h-full mb:h-full w-full zoom   mb:relative mb:top-0 bg-blend-multiply absolute ' onClick={(e)=>{ console.log('bublin'); setfilterClick('')}} >
