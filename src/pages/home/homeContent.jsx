...
const HomeContent = () => {
  ...
  return (
    // absolute top-[15vh]
    <section className=' xl:bg-gradient-to-tr 2xl:bg-gradient-to-tr 3xl:bg-gradient-to-tr  lg:bg-gradient-to-tr md:bg-gradient-to-tr sm:bg-white  from-pink-50 via-pink-50   to-blue-50 mix-blend-multiply             text-black  h-[90%]   w-full zoom    bg-blend-multiply  mb:relative mb:top-0 mb:h-[80vh] relative mb:bg-red-500' onClick={(e)=>{ console.log('bublin'); setfilterClick('')}} >
    {/* mt-5 */}
    ...
    {/* mt-28 mb:mt-[169px] */}
       ...
       text-center '>       
         <h1 className='text-bigHeading h-fit w-[50.5%] mx-auto     text-justify mb:w-[310px] sm:w-[310px]
                ...
                xl:text-[2rem] 
                2xl:text-[2.2rem]  
         text-black  mb:text-[#C0C0C0]  font-light mb:text-responsive-heading'>
       ...
       <div className='mx-auto rounded-xl mt-48 mb:mt-[10vh] flex flex-row items-center  gap-10 w-auto  mb:flex-col mb:gap-5 md:mt-[20vh]  2xl:mt-[7vh] xl:mt-[12vh] lg:mt-[18vh]'>
          <div>
