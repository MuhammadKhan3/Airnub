...
const HomeContent = () => {
  ...
  return (
    <section className=' xl:bg-gradient-to-tr 2xl:bg-gradient-to-tr 3xl:bg-gradient-to-tr  bg-gradient-to-tr  from-pink-50 via-pink-50   to-blue-50 mix-blend-multiply       flex flex-col items-center justify-center      text-black  h-fit  mb:h-[85%] w-full zoom   mb:relative mb:top-0 bg-blend-multiply' onClick={(e)=>{ console.log('bublin'); setfilterClick('')}} >
